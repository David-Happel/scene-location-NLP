...
def plot_grid_search():
    ...
    source_path = '/home/david/Projects/NLP-project/reports/report-2020-06-01-17-30-34-elmo-grid/elmo_grid_search.pkl'
    ...
    results['std'] = results[['split0_test_score', 'split1_test_score', 'split2_test_score',
                              'split3_test_score', 'split4_test_score']].std(axis=1)
    ax = results.plot.bar(x='param_C', y=['mean_test_score', 'mean_train_score'],
                          yerr='std', ecolor='black', fontsize=14)
