...
def inspect_data():
    ...
    source_guesses_path = '/home/david/Projects/NLP-project/reports/report-2020-05-25-09-36-22/elmo_test_results.pkl'
    ...
    scatterplot_path = os.path.dirname(os.path.split(source_guesses_path)[0])
