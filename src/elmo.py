...
with tf.Session() as session:
    ...
    history = model_elmo.fit(X, y, epochs=EPOCHS, batch_size=BATCH_SIZE, validation_split=0.2)
...
with tf.Session() as session:
    ...
    score = model_elmo.evaluate(valid_X, valid_y, verbose=0, batch_size=BATCH_SIZE)
